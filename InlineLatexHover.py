...
class InlineLatexHover(sublime_plugin.EventListener):
    ...
    def get_colors(view):
        ...
        # Check color scheme file format
        if scheme_path.lower().endswith(".sublime-color-scheme"):
            ...
            try:
                ...
                try:
                    ...
                    bg = scheme_data["settings"][0]["settings"]["background"][1:] + "00"
        ...
        # Default values in case of unknown format 
        else:
            bg = "000000"
            fg = "FFFFFF"
